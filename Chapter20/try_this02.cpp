/*
    Run your own version of that timing experiment.
    Run it at least three times and with at least three different 
    numbers of elements. Explain your results.
*/
...
int main() {
    std::vector<std::pair<std::string,int>> v = generate(10000000);      //generate some data
    ...
    /*OUTPUT: 
        ...
        The reason our program takes longer for higher sample
        sizes should be self-explanatory. However, the reason map[] 
        is orders of magitude faster than vector, which is in turn orders of 
